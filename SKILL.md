...
description: >
  ...
  "go rudy this <scenario>", "rudy <scenario>", or "reverse engineer intune <scenario>".
...
The user invokes this by saying "go rudy this <scenario>", "rudy <scenario>", or
"reverse engineer intune <scenario>". The deliverable is a markdown post in the
investigative style described under "Output" below.
